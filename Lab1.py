...
class Lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_win = qtgui.RangeWidget(self._frequency_range, self.set_frequency, "frequency in Hz", "eng_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._frequency_win)
        self._amplitude_range = qtgui.Range(0, 5, 100e-3, 1, 200)
        self._amplitude_win = qtgui.RangeWidget(self._amplitude_range, self.set_amplitude, "amplitude_adimensional", "slider", float, QtCore.Qt.Horizontal)
